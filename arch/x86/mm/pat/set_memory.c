...
/*
 * Check if a pgprot_t is "standard" kernel protection bits.
 * If all entries in PMD/PUD has standard protection bits,
 * kernel can merge them into one PMD/PUD entry.
 */
static __always_inline bool standard_pgprot(pgprot_t prot)
{
	/* Large entries should also be considered as standard too. */
