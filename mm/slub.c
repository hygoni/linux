...
inline void *__kmem_cache_alloc_node(struct kmem_cache *s, gfp_t gfpflags,
...
noinline void *kmalloc_node_trace(struct kmem_cache *s,
				    gfp_t gfpflags,
...
inline void __kmem_cache_free(struct kmem_cache *s, void *x, unsigned long caller)
{
